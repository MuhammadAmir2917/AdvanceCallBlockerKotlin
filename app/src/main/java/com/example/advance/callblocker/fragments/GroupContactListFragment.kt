...
import kotlinx.android.synthetic.main.fragment_group_contact_list.*

class GroupContactListFragment(private val groupId: Long) : BaseFragment(),
    OnContactOptionClickListener {
    override val layoutResources: Int
        get() = R.layout.fragment_group_contact_list

    companion object{
        fun newInstance(groupId: Long) = GroupContactListFragment(groupId)
